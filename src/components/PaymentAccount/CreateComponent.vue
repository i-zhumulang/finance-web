...
<template>
  <el-form v-if="createClass.indexClass.getCreateDialog()"
    ...
    <el-form-item prop="name" label="账号名称">
      <el-input v-model="createClass.data.name" autocomplete="off" placeholder="请输入2~30字符的账号名称"/>
    </el-form-item>
    <el-form-item prop="account" label="账号">
      <el-input v-model="createClass.data.account" autocomplete="off" placeholder="请输入2~30字符的账号"/>
    </el-form-item>
    <el-form-item>
