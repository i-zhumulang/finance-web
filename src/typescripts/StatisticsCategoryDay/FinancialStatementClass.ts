...
import type { FinancialStatementInterface } from "@/typescripts/StatisticsCategoryDay/DataTypeInterface";
import { reactive } from "vue";
import type { UnwrapNestedRefs } from "vue";
import LoadingClass from "@/typescripts/Common/Common/Objects/LoadingClass";
import StatisticsCategoryDayRequest from "@/requests/StatisticsCategoryDayRequest";
import type { AxiosError, AxiosResponse } from "axios";
import type ApiParamsInterface from "@/typescripts/Common/Common/Interfaces/ApiParamsInterface";
import { ElMessage } from "element-plus";
import type IndexClass from "@/typescripts/StatisticsCategoryDay/IndexClass";
...
export default class FinancialStatementClass extends BaseClass {
    ...
    public index(): void {
        ...
        new StatisticsCategoryDayRequest()
