...
export default class StatisticsUserClass extends BaseClass implements Index {

    public statisticsUserRef = ref();

    public index(): void {
        type EChartsOption = echarts.EChartsOption;
        const myChart = echarts.init(this.statisticsUserRef.value);
